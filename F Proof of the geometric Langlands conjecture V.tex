...
The assertion of the lemma automatically extends to algebraic stacks. We apply it to the fibers of the map
...
\ssec{2-Fourier-Mukai transform and Poincar\'e duality} \label{ss:FM and Verdier}
...
\noindent{\em(a)} The pairing \eqref{e:Verdier pairing Gamma} is of 2-Fourier-Mukai type.

\smallskip

\noindent{\em(b)} The composition 
